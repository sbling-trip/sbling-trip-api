...
from api_python.app.wish.repository.wish_repository import get_stay_info_with_for_user_wish_limit_offset
...
async def get_stay_wish_all_list_service(
    ...
    result = await get_stay_info_with_for_user_wish_limit_offset(
        user_seq=user_seq,
